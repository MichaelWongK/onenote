...
![图片描述](http://www.micheal.wang:10020/mongo/read/5f33fce39c5fd27c4ff5d881)图中左边竖着的是 HashMap 的数组结构，数组的元素可能是单个 Node，也可能是个链表，也可能是个红黑树，比如数组下标索引为 2 的位置就是一个链表，下标索引为 9 的位置对应的就是红黑树，具体细节我们下文再说。
...
我们来画一张示意图来描述下：
![图片描述](http://www.micheal.wang:10020/mongo/read/5f33fd009c5fd27c4ff5d883)代码细节如下：
